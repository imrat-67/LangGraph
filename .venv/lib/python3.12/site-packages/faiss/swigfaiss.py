...
class SIMDConfig(object):
    ...
    def has_dynamic_dispatch():
        r"""Whether this faiss build dispatches SIMD at runtime."""
...
class IndexFlatL2Panorama(IndexFlatPanorama):
    ...
    def __init__(self, *args):
        ...
        :param batch_size: batch size for Panorama storage
        """
        _swigfaiss.IndexFlatL2Panorama_swiginit(self, _swigfaiss.new_IndexFlatL2Panorama(*args))
...
class IndexFlatIPPanorama(IndexFlatPanorama):
    ...
    def __init__(self, *args):
        ...
        :param batch_size: batch size for Panorama storage
        """
        _swigfaiss.IndexFlatIPPanorama_swiginit(self, _swigfaiss.new_IndexFlatIPPanorama(*args))
...
class ClusteringParameters(object):
    ...
    """)
    use_super_kmeans = property(_swigfaiss.ClusteringParameters_use_super_kmeans_get, _swigfaiss.ClusteringParameters_use_super_kmeans_set, doc=r"""
...
class Panorama(object):
    ...
    kLegacyBatchSize = _swigfaiss.Panorama_kLegacyBatchSize
...
class HadamardRotation(VectorTransform):
    ...
    def reverse_transform(self, n, xt, x):
        r"""Apply the inverse transform when d_in == d_out."""
        return _swigfaiss.HadamardRotation_reverse_transform(self, n, xt, x)
...
class HNSW(object):
    ...
    SM_DEFAULT = _swigfaiss.HNSW_SM_DEFAULT
    SM_PANORAMA = _swigfaiss.HNSW_SM_PANORAMA
    SM_RABITQ = _swigfaiss.HNSW_SM_RABITQ
    search_method = property(_swigfaiss.HNSW_search_method_get, _swigfaiss.HNSW_search_method_set)
    ...
    def compute_forward_links_deterministic(self, ptdis, pt_level, pt_id, vt, pt_reverse_edges, keep_max_size_level0=False):
        r"""
        ...
        entry_point set.
        """
        return _swigfaiss.HNSW_compute_forward_links_deterministic(self, ptdis, pt_level, pt_id, vt, pt_reverse_edges, keep_max_size_level0)

    def merge_reverse_links_deterministic(self, dis, node, level, incoming, keep_max_size_level0=False):
        r"""
        ...
        """
        return _swigfaiss.HNSW_merge_reverse_links_deterministic(self, dis, node, level, incoming, keep_max_size_level0)
...
def hnsw_add_vertices_deterministic(hnsw, n0, n, d, init_level0, keep_max_size_level0, preset_levels, verbose, make_distance_computer, set_query):
    r"""
    ...
    """
    return _swigfaiss.hnsw_add_vertices_deterministic(hnsw, n0, n, d, init_level0, keep_max_size_level0, preset_levels, verbose, make_distance_computer, set_query)
...
class IndexHNSWRaBitQ(IndexHNSW):
    ...
    def __init__(self, *args):
        _swigfaiss.IndexHNSWRaBitQ_swiginit(self, _swigfaiss.new_IndexHNSWRaBitQ(*args))
    __swig_destroy__ = _swigfaiss.delete_IndexHNSWRaBitQ

# Register IndexHNSWRaBitQ in _swigfaiss:
_swigfaiss.IndexHNSWRaBitQ_swigregister(IndexHNSWRaBitQ)
...
class IndexIVFPQ(IndexIVF):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ScannerMode_Precomputed = _swigfaiss.IndexIVFPQ_ScannerMode_Precomputed
    ScannerMode_OnTheFly = _swigfaiss.IndexIVFPQ_ScannerMode_OnTheFly
    ...
    def get_InvertedListScanner(self, *args):
        r"""Returns a scanner with a fixed PQ distance-computation strategy."""
        return _swigfaiss.IndexIVFPQ_get_InvertedListScanner(self, *args)
...
class RaBitQStats(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    n_1bit = property(_swigfaiss.RaBitQStats_n_1bit_get, _swigfaiss.RaBitQStats_n_1bit_set)
    n_refine = property(_swigfaiss.RaBitQStats_n_refine_get, _swigfaiss.RaBitQStats_n_refine_set)

    def reset(self):
        return _swigfaiss.RaBitQStats_reset(self)

    def add(self, other):
        return _swigfaiss.RaBitQStats_add(self, other)

    def refine_ratio(self):
        return _swigfaiss.RaBitQStats_refine_ratio(self)
...
class RaBitQDistanceComputer(FlatCodesDistanceComputer):
    ...
    stats = property(_swigfaiss.RaBitQDistanceComputer_stats_get, _swigfaiss.RaBitQDistanceComputer_stats_set, doc=r"""Per-distance-computer counters, aggregated by the owning index.""")

    def symmetric_dis(self, i, j):
        return _swigfaiss.RaBitQDistanceComputer_symmetric_dis(self, i, j)
...
class IDScanContext(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ids = property(_swigfaiss.IDScanContext_ids_get, _swigfaiss.IDScanContext_ids_set, doc=r"""the contiguous block of ids being scanned""")
    list_size = property(_swigfaiss.IDScanContext_list_size_get, _swigfaiss.IDScanContext_list_size_set, doc=r"""number of entries in `ids`""")
    j = property(_swigfaiss.IDScanContext_j_get, _swigfaiss.IDScanContext_j_set, doc=r"""index of the tested id within `ids` (i.e. ids[j] == id)""")

    def __init__(self):
        _swigfaiss.IDScanContext_swiginit(self, _swigfaiss.new_IDScanContext())
    __swig_destroy__ = _swigfaiss.delete_IDScanContext

# Register IDScanContext in _swigfaiss:
_swigfaiss.IDScanContext_swigregister(IDScanContext)
class IDSelectorWithContext(IDSelector):
    r"""
    ...
    def is_member_with_context(self, id, ctx):
        return _swigfaiss.IDSelectorWithContext_is_member_with_context(self, id, ctx)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorWithContext

# Register IDSelectorWithContext in _swigfaiss:
_swigfaiss.IDSelectorWithContext_swigregister(IDSelectorWithContext)
class IDSelectorContextDispatch(object):
    r"""
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    sel = property(_swigfaiss.IDSelectorContextDispatch_sel_get, _swigfaiss.IDSelectorContextDispatch_sel_set)
    ctx_sel = property(_swigfaiss.IDSelectorContextDispatch_ctx_sel_get, _swigfaiss.IDSelectorContextDispatch_ctx_sel_set)

    def __init__(self, sel, store_pairs):
        _swigfaiss.IDSelectorContextDispatch_swiginit(self, _swigfaiss.new_IDSelectorContextDispatch(sel, store_pairs))

    def is_member(self, id, ctx):
        return _swigfaiss.IDSelectorContextDispatch_is_member(self, id, ctx)
    __swig_destroy__ = _swigfaiss.delete_IDSelectorContextDispatch

# Register IDSelectorContextDispatch in _swigfaiss:
_swigfaiss.IDSelectorContextDispatch_swigregister(IDSelectorContextDispatch)
